...
class Check(ExtendedPage):
    ...
    """
    default_hint = _('This is wrong. Please try again.')
    default_hint_empty = _('You still need to answer this question.')
    ...
    template_name = 'floodgame_nonvr/Check.html'
